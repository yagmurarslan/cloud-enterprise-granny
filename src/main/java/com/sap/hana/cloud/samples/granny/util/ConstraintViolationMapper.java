package com.sap.hana.cloud.samples.granny.util;
...
public class ConstraintViolationMapper 
{
	Logger log = LoggerFactory.getLogger(ConstraintViolationMapper.class);
	 ...
	 // TODO I18N
    static StatusMessage DEFAULT_MSG = new StatusMessage(HttpStatus.BAD_REQUEST.value(), "api.data_validation.error", null, "Data validation failed!");
